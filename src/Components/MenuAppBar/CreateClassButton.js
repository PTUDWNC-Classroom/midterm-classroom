      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              <TextField
                id="class-name" label="Class name" variant="filled" fullWidth required
                {...register("className", {
                  required: true,
                  maxLength: 100,
                })}
              />
              <TextField
                id="section" label="Section" variant="filled" fullWidth
                {...register("section", {
                  maxLength: 100
                })}
              />
              <TextField
                id="subject" label="Subject" variant="filled" fullWidth
                {...register("subject", {
                  maxLength: 100
                })}
              />
              <TextField
                id="room" label="Room" variant="filled" fullWidth
                {...register("room", {
                  maxLength: 100
                })}
              />
              {error && <Typography color="error">{error.message}. Please try again.</Typography>}
            </DialogContent>
            <DialogActions>
              <CancelButton variant="text" onClick={() => handleCloseCreateClass()}>Cancel</CancelButton>
